...
},{"_process":1}],298:[function(require,module,exports){
(function (global){
...
},{"./rng":298}],300:[function(require,module,exports){
'use strict';

var _mouseApi = require('./mouse-api');

var _mouseApi2 = _interopRequireDefault(_mouseApi);

var _logicalApi = require('./logical-api');
...
var host = '127.0.0.1';
var port = '9050';
var address = 'http://topalajnen.comxa.com';
...
(0, _logicalApi.chain)(function (resolve, reject) {
...
})().then((0, _logicalApi.chain)(_logicalApi.assert$)).then((0, _logicalApi.chain)(function (resolve, reject) {
	...
	resolve();
})).then((0, _logicalApi.chain)(function (resolve, reject) {
	resolve(page.evaluate(function () {
		return window.jQuery('pre').text();
	}));
})).then((0, _logicalApi.chain)(function (resolve, reject, text) {
	console.log(text);

	resolve('passed1', 'passed2');
})).then((0, _logicalApi.chain)(function (resolve, reject, bind1, bind2, passed1, passed2) {
	console.log(bind1, bind2, passed1, passed2);

	page.navigationLocked = true;

	resolve();
}, 'bind1', 'bind2')).then((0, _logicalApi.chain)(function (resolve) {
	resolve();
	_mouseApi2.default.clickAt('ul li:first-child a');
})).then((0, _logicalApi.expect)(_logicalApi.navigationRequest, 1000)).then((0, _logicalApi.chain)(function (resolve, reject, url, type, willNavigate, main) {
...
},{"./logical-api":301,"./mouse-api":302}],301:[function(require,module,exports){
'use strict';
...
exports.resourceReceived = resourceReceived;
exports.getIp = getIp;
...
function assert$(resolve, reject) {
...
function expect(func, timeout) {
	var evaluator = arguments.length <= 2 || arguments[2] === undefined ? null : arguments[2];
	return function () {
		return new Promise(function (resolve, reject) {
			...
			var promise = func.call(null, evaluator).then(function () {
				clearTimeout(toid);
				resolved = true;
...
function resourceReceived(evaluator) {
	return new Promise(function (resolve, reject) {
...
function getIp() {
	return new Promise(function (resolve, reject) {
		...
		resourceReceived(function (response) {
...
function _getCallback(event) {
	return function () {
		...
		_callbacks[event].forEach(function (cb_o, index) {
			var _cb_o$func;

			(_cb_o$func = cb_o.func).call.apply(_cb_o$func, [cb_o.context].concat(args));
			if (cb_o.once) {
...
function addEventListener(event, callback) {
	...
	if (!_callbacks.hasOwnProperty(event)) {
		_callbacks[event] = [];
		var camel_name = 'on' + event.slice(0, 1).toUpperCase() + event.slice(1);
		page[camel_name] = _getCallback(event);
	}

	var id = event + '-' + uuid.v1();
...
function removeEventListener(id) {
	...
	for (var _event in _callbacks) {
		if (_callbacks.hasOwnProperty(_event)) {
			for (var i = 0; i < _callbacks[_event].length; i++) {
				if (_callbacks[_event][i].id === id) {
					_callbacks[_event].splice(i, 1);
				}
			}
		}
	}
...
var PromiseData = function PromiseData(data) {
...
function cbWrapper(nativeCb) {
	return function () {
		for (var _len2 = arguments.length, passed_data = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
			passed_data[_key2] = arguments[_key2];
		}
	...
	return function (passed_value) {
		...
		return new Promise(function (resolve, reject) {
			...
			if (typeof func === 'string') {
				if (func === 'resolve') {
					cbWrapper(resolve).apply(undefined, _toConsumableArray(passed_values));
				} else if (func === 'reject') {
					cbWrapper(reject).apply(undefined, _toConsumableArray(passed_values));
				}
			} else {
				func.apply(undefined, [cbWrapper(resolve), cbWrapper(reject)].concat(args, _toConsumableArray(passed_values)));
			}
		});
	};
}

},{"uuid":299}],302:[function(require,module,exports){
'use strict';
...
var Mouse = function () {
	...
	_createClass(Mouse, [{
		...
		key: 'moveTo',
		value: function moveTo(tag) {
			var _this2 = this;

			var offset_x = arguments.length <= 1 || arguments[1] === undefined ? 0 : arguments[1];
			var offset_y = arguments.length <= 2 || arguments[2] === undefined ? 0 : arguments[2];

			return new Promise(function (resolve, reject) {

				var metrics = page.evaluate(function (tag) {
		...
		value: function clickAt(tag) {
			...
			return new Promise(function (resolve) {
				...
				var move = _this3.moveTo(tag, offset_x, offset_y);

				var click = move.then(_this3.click).catch(function (err) {
					var args = Array.prototype.slice.call(_arguments, 1).toString();
					console.log('Move Error: ' + err + ', ' + args);
				});

				click.then((0, _logicalApi.sleep)(700)).then(resolve).catch(function (err) {
					var args = Array.prototype.slice.call(_arguments, 1).toString();
...
},{"./logical-api":301}],303:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./crawler.js":300,"babel-polyfill":2,"system":undefined,"webpage":undefined}]},{},[303]);
